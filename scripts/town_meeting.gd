...
func _ready():
	...
	await dialog_box.show_dialog(0, "The situation is worsening - from rising sea levels to more extreme weather. The National Adaptation Plan doesn't address these situations.")
